"""
from: https://github.com/zhaoyue-zephyrus/bsq-vit
"""
...
class BinarySphericalQuantizer(nn.Module):
    ...
    def forward(self, z):
        ...
        # commit loss
        commit_loss = self.beta * torch.mean(((zq.detach() - z) ** 2).sum(dim=-1)) # beta/commit_loss_weight is fixed at 1, biased in mse.py
        ...
        return (
            ...
            {"H": cb_entropy, "used_codes": used_codes, "codes": indices, "group_indices": group_indices,
             "avg_prob": avg_prob, 'ent_loss': entropy_penalty, 'commit_loss': commit_loss}
        )
